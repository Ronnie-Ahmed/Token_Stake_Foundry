...
contract TokenStaking is ReentrancyGuard, Ownable {
    ...
    */
    ...
    uint256[] public s_stakedays;
    uint256[] public perApyRate;

    constructor(address TokenAddress) {
        StakeToken = IERC20(TokenAddress);
        s_stakedays = [7, 10, 30, 45, 90];
        perApyRate = [10, 20, 30, 40, 50];
    ...
    */
    ...
    function getMax_Stake_Value() public view returns (uint256) {
        return MAX_STAKE_VALUE;
    }

    function getMin_Stake_Value() public view returns (uint256) {
        return MIN_STAKE_VALUE;
    }

    function getUnstake_Fee() public view returns (uint256) {
        return unStakeFee;
    }
}
